...
public class GizmoChangeArgs : EventArgs
{
...
public class Gizmo
{
  ...
  private void WriteMatrix()
  {
    ...
    GizmoChanged?.Invoke(this, new GizmoChangeArgs() { position = translate });
  }
